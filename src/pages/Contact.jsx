...
const Contact = () => (
	<Box sx={{ p: { xs: 2, sm: 4 }, bgcolor: '#f9f9fb', color: '#18181a' }}>
		...
		<Box textAlign="center" mb={5}>
			...
			<Typography variant="h6" sx={{ color: '#666', fontSize: { xs: 15, sm: 25 } }}>We’d love hear from you. Please fill out this form.</Typography>
		</Box>
		<Box component="form" sx={{ maxWidth: 600, mx: 'auto', p: 4 }}>
			<Grid>
				...
				<Grid
					item
					sx={{ mt: { xs: 3, sm: 5 }, textAlign: "center" }}
					xs={12}
				>
					<button
						type="submit"
		...
		<Box sx={{ width: '70%', p: 4, margin: 'auto' }}>
			<Grid container alignItems="center" sx={{ display: 'flex', justifyContent: 'space-between' }} spacing={2}>
				<Grid item xs={12} md={6}>
					<Typography variant="h6" sx={{ fontWeight: 600, fontSize: { xs: 15, sm: 25 } }}>
